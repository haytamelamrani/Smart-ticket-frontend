...
export default function AllTicketsPage() {
  ...
  const filteredTickets = useMemo(() => {
    ...
    return filtered
  }, [tickets, userRole, userEmail, searchTerm, selectedCategory])
  ...
  // Fonction pour changer le statut d'un ticket (ADMIN/AGENT uniquement)
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {getDetailedTimeElapsed(
                            ticket.etatUpdatedAt && ticket.etatUpdatedAt !== "null" ? ticket.etatUpdatedAt : ticket.createdAt
                          )}
